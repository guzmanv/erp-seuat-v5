        ...
        <div class="card mt-1">
          ...
          <form id="fromNvoMedioCaptacion" name="fromNvoMedioCaptacion" autocomplete="off">
            ...
            <div class="modal-footer">
              <a class="btn btn-outline-secondary icono-color-principal btn-inline cerrarModal" href="#" data-dismiss="modal"><i class="fa fa-fw fa-lg fa-times-circle icono-azul" id="cancelarModalEditMed"></i>Cancelar</a>
