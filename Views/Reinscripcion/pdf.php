...
<div id="header_pdf">
    ...
    <div id="content_pdf">
        <div style="width:759px; font-size:16px; font-weight: bold; letter-spacing: 0.2em; text-align: center; "> SOLICITUD DE REINSCRIPCION</div>
        ...
        <?php if($data['datos']['nombre_grado'] != 1){?>
            <div id="fila-normal">
                ...
                <div class="subfila" style="width:505px; height: 12px; float:left; background-color: #eae9e9; padding: 5px 2px 4px 4px; text-align: left; "><?php echo(strtoupper($data['datos']['nombre_grado']))?> cuatrimestre</div>
            </div>
        <?php } ?>
        ...
        <div style="width:759px; background-color: #eae9e9; margin-top:7px; ">
            <div class="subfila" style="width:308px; height: 12px; padding: 5px 0px 4px 0px; text-align: center; float-left; "></div>
