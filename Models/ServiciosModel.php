...
class ServiciosModel extends Mysql{
    ...
    public function updateServicio(int $intIdServicio,string $strCodigo_servicio,string $strNombre_servicio,string $intPrecio_unitario,int $intIdCategoria_servicio,int $intIdUnidades_medida,int $strAnio_fiscal,int $intAplica_edo_cuenta,int $intIdPlantel,int $intEstatus,int $id_user){
        ...
        $arrRequest = $this->update($sql,array($strCodigo_servicio,$strNombre_servicio,$intPrecio_unitario,$intIdCategoria_servicio,$intIdUnidades_medida,$strAnio_fiscal,$intAplica_edo_cuenta,$intIdPlantel,$intEstatus,$id_user));
        return $arrRequest;
    }
