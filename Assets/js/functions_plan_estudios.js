    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData) {
                ...
                document.querySelector('#listInstitucionEdit').querySelector('option[value="' + objData.plan_estudio.id_instituciones + '"]').selected = true;
                document.querySelector('#listNivelEdEdit').querySelector('option[value="' + objData.plan_estudio.id_nivel_educativos + '"]').selected = true;
                document.querySelector('#listCategoriaEdit').querySelector('option[value="' + objData.plan_estudio.id_categoria_carreras + '"]').selected = true;
                ...
                document.querySelector('#listModalidadEdit').querySelector('option[value="' + objData.plan_estudio.id_modalidades + '"]').selected = true;
                ...
                document.querySelector('#listPlanEdit').querySelector('option[value="' + objData.plan_estudio.id_organizacion_planes + '"]').selected = true;
